...
const (
	...
	TokenValidation_ValidateDataUser_FullMethodName = "/tokenvalidation.TokenValidation/ValidateDataUser"
)
...
type TokenValidationClient interface {
	...
	ValidateDataUser(ctx context.Context, in *DataUser, opts ...grpc.CallOption) (*UserResponse, error)
}
...
func (c *tokenValidationClient) ValidateDataUser(ctx context.Context, in *DataUser, opts ...grpc.CallOption) (*UserResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserResponse)
	err := c.cc.Invoke(ctx, TokenValidation_ValidateDataUser_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TokenValidationServer interface {
	...
	ValidateDataUser(context.Context, *DataUser) (*UserResponse, error)
...
func (UnimplementedTokenValidationServer) ValidateDataUser(context.Context, *DataUser) (*UserResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ValidateDataUser not implemented")
}
...
func _TokenValidation_ValidateDataUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DataUser)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TokenValidationServer).ValidateDataUser(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TokenValidation_ValidateDataUser_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TokenValidationServer).ValidateDataUser(ctx, req.(*DataUser))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TokenValidation_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ValidateDataUser",
			Handler:    _TokenValidation_ValidateDataUser_Handler,
		},
	},
